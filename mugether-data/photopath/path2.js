...
const rootDirectory = './mugether-data/photofile/Nearby/travel'
const Mu_PLACE = require('../mugether-data/rawfile/JSON/Travel_Mu_3.json')
...
fs.writeFileSync('testTRAVEL.json',JSON.stringify(newnewnew,null,2))